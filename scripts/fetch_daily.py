#!/usr/bin/env python3
"""
Runs once daily after Americas market close (~22:00 UTC).
Fetches full price history for Americas indexes (Stooq + Yahoo fallback).
"""
...
def main():
    ...
    print(f"=== fetch_daily.py (americas-indexes)  {ts} ===")
