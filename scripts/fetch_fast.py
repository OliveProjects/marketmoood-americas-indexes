...
Fetches intraday (1m/1d) and weekly (60m/5d) for Americas stock indexes.
"""
...
def main():
    ...
    print(f"=== fetch_fast.py (americas-indexes)  {ts} ===")
    ...
    save("data/americas-intraday.json", {"fetched_at": now_ms, "assets": intraday})
    save("data/americas-weekly.json",   {"fetched_at": now_ms, "assets": weekly})
